...
WEAPON_SKILL_POWER  = 1.333 -- Multiplies damage dealt by Weapon Skills.
...
HEALING_TP_CHANGE       = -40 -- Change in TP for each healing tick. Default is -100
...
ABSORB_SPELL_TICK = 27 -- duration of 1 absorb spell tick
...
GOBBIE_BOX_MIN_AGE  = 05 -- Minimum character age in days before a character can sign up for Gobbie Mystery Box
